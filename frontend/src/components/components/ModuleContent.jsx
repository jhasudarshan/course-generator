  ...
  return (
    <div className="module-content">
      ...
      <div className="module-navigation">
        {activeModuleIndex > 0 && (
          <button className="nav-button prev-button" onClick={() => setActiveModuleIndex(activeModuleIndex - 1)}>
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        {activeModuleIndex < currentCourse.modules.length - 1 && (
          <button className="nav-button next-button" onClick={() => setActiveModuleIndex(activeModuleIndex + 1)}>
            Next Module
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
